...
class Collins {
    constructor(serverName, accessKey, requestHandler) {
    ...
    didYouMean(dictionaryCode, searchWord, entryNumber, callback) {
        var sentData = this.requestData('dictionaries/' + dictionaryCode + '/search/didyoumean/', { q: searchWord, entrynumber: entryNumber });
        this.get(sentData, callback);
    }
    ...
    first(dictionaryCode, searchWord, format, callback) {
        var sentData = this.requestData('dictionaries/' + dictionaryCode + '/search/first/', {q: searchWord, format: format});
        this.get(sentData, callback);
    }
    ...
    entry(dictionaryCode, entryId, format, callback) {
        var sentData = this.requestData('dictionaries/' + dictionaryCode + '/entries/' + entryId, {format: format});
        this.get(sentData, callback);
    }
    ...
    pronunciation(dictionaryCode, entryId, lang, callback) {
        var sentData = this.requestData('dictionaries/' + dictionaryCode + '/entries/' + entryId + '/pronunciations', {lang: lang});
        this.get(sentData, callback);
    }
    ...
    nearby(dictionaryCode, entryId, entryNumber, callback) {
        var sentData = this.requestData('dictionaries/' + dictionaryCode + '/entries/' + entryId + '/nearbyentries', {entrynumber: entryNumber});
        this.get(sentData, callback);
    }
}
